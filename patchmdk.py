...
batch_portability = 'call "runtime\\bin\\python\\python_mcp.exe" "patchportability.py" "" "%~dp0"\n' if ( os.getenv("patchoneone") == "T" ) else ""
batch_portability_forge = 'call "..\\runtime\\bin\\python\\python_mcp.exe" "..\\patchportability.py" ".." "%~dp0"\n'
